// www.midijs.net/lib/midi.js'
!function (t) {
    try {
        t.MIDIjs = new Object, t.MIDIjs.initError = "initializing ...";
        var n, s, l, u, r, d, c = 6, m = null, p = 0, o = 32768, f = 8192, g = 0, a = 0, I = 0, b = !1, M = "", w = -1,
            j = "", y = !1, v = 0, h = !1, _ = 100, D = null, A = null, k = "libtimidity-for-worklet.js?v=" + c,
            x = null, O = new Array, C = 440, E = new Int32Array(128), T = Math.pow(2, 1 / 12);
        ...
        function V(e, t, n) {
            if (-1 != e.indexOf("data:")) {
                var r = e.indexOf(",") + 1, o = atob(e.substring(r));
        ...
        function F(e, t, n) {
            ...
            if (I = Module.ccall("mid_song_load", "number", ["number", "number"], [r, t]), rval = Module.ccall("mid_istream_close", "number", ["number"], [r]), 0 < (g = Module.ccall("mid_song_get_num_missing_instruments", "number", ["number"], [I]))) for (var o = 0; o < g; o++) {
        ...
        function ue(t, n) {
            m.audioWorklet.addModule(M + k).then(function () {
                var o = new AudioWorkletNode(m, "midijs-audio-worklet"), e = new Object;
        ...
        var ce = (M = (M = function () {
                for (var e = 0; e < document.scripts.length; e++) {
                    var t = document.scripts[e].src, n = t.lastIndexOf("/midi.js");
        ...
        t.MIDIjs.set_logging = function (e) {
            ...
            if (Array.isArray(e)) if (128 == e.length) for (t = 0; t < 128; t++) E[t] = 1e3 * e[t]; else {
                if (!Array.isArray(e) || 12 != e.length) return console.warn("Ignoring unknown frequency table. Must be array[12] or array[128]"), !1;
                oe(E, e)
            } else if ("string" == typeof e) {
                var r = e.split("-")[0], o = parseInt(e.split("-")[1], 10);
                if ((void 0 === o || isNaN(o) || o < 0 || 11 < o) && (o = 0), "detuned" == r) for (t = 0; t < 128; t++) {
                    var a = 1 + (Math.random() - .5) / (1 / o * 100);
                    E[t] = a * Math.round(C * Math.pow(T, t - 69) * 1e3)
                } else if ("equal" == r) de(E); else if ("pythagorean" == r) {
                    var i = new Array(12);
        ...
        }, t.MIDIjs.stop = K, "audioMethod: &lt;object&gt;") : (t.MIDIjs.play = function (e) {
        }, t.MIDIjs.stop = function (e) {
        }, "audioMethod: No method found"), "Microsoft Internet Explorer" == me.browserName && "https:" == location.protocol.toLowerCase() && setTimeout(function () {
